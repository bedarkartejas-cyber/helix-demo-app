    ...
    if (fs.existsSync(seedDbPath)) {
        ...
        if (!userDbExists) {
            ...
            if (seedStat.mtime > userDbStat.mtime) {
                shouldCopy = true;
                console.log(
                    "Seed database is newer. Overwriting user database."
                );
                console.log(
                    "Seed database is newer. Overwriting user database."
                );
...
export function seedDatabase(db: initSqlJs.Database) {
    ...
    const personas = [
        ...
        [
            "creator",
            "Creator",
            "media/screensavers/creator_helix.mp4",
            "#9333EA",
        ],
        ...
        [
            "student",
            "Student",
            "media/screensavers/student_helix.mp4",
            "#10B981",
        ],
    ];
    personas.forEach((p) => {
    ...
    const techSpecs = [
        ...
        [
            "omen-17",
            "Display",
            '17.3" QHD (2560 x 1440)',
            "240Hz, 3ms, IPS, 100% sRGB",
            "FiMonitor",
        ],
        [
            "omen-17",
        ...
        [
            ...
            "Ports",
            "1x Thunderbolt™ 4",
            "3x USB-A, 1x HDMI 2.1, 1x RJ-45",
            "FiLayout",
        ],
        [
            "omen-17",
            "Battery",
            "83 Wh Li-ion polymer",
            "330W Smart AC Adapter",
            "FiBattery",
        ],
        [
            "omen-17",
        ...
        [
            ...
            "Ports",
            "1x USB-C®, 3x USB-A",
            "1x HDMI 2.1, 1x RJ-45",
            "FiLayout",
        ],
        [
            "victus-16",
            "Battery",
            "70 Wh Li-ion polymer",
        ...
        [
            "spectre-16",
            "Display",
            '16" 2.8K (2880 x 1800) OLED',
            "Touch, 120Hz, HDR 500, VRR",
            "FiEye",
        ],
        [
            "spectre-16",
            "Memory",
            "32 GB LPDDR5x-6400",
            "Onboard (High Bandwidth)",
            "FiServer",
        ],
        [
            "spectre-16",
            "Webcam",
            "HP Wide Vision 9MP IR",
            "Night mode, AI Auto Frame",
            "FiVideo",
        ],
        [
            "spectre-16",
            "Audio",
            "Poly Studio Quad Speakers",
            "DTS:X® Ultra",
            "FiHeadphones",
        ],
        [
        ...
        [
            ...
            "Features",
            "Haptic Touchpad",
            "Walk Away Lock / Wake on Approach",
            "FiLock",
        ],
        [
            "spectre-16",
        ...
        [
            ...
            "Webcam",
            "5MP IR Camera",
            "Dual array mics, AI Noise Reduction",
            "FiVideo",
        ],
        [
            "elitebook-840",
        ...
        [
            ...
            "Ports",
            "2x Thunderbolt™ 4",
            "2x USB-A, 1x HDMI 2.1, SmartCard",
            "FiLayout",
        ],
        [
            "elitebook-840",
        ...
        [
            ...
            "OS",
            "Windows 11 Pro",
            "Downgrade rights to Win 10 Pro",
            "FiCommand",
        ],
        ...
        [
            ...
            "Processor",
            "Intel® Core™ i5-1335U",
            "10 Cores, Efficient Business Power",
            "FiCpu",
        ],
        [
            "probook-450",
        ...
        [
            ...
            "Instant electronic privacy screen",
            "FiEyeOff",
        ],
        [
            "elite-x360",
        ...
        [
            ...
            "Display",
            '14" FHD (1920 x 1080)',
            "Multitouch-enabled, Edge-to-edge",
            "FiMonitor",
        ],
        [
            "pavilion-x360",
        ...
        [
            ...
            "Value",
            "EPEAT® Gold Registered",
            "Ocean-bound plastic construction",
            "FiGlobe",
        ],
    ...
    const repoBaseUrl =
        "https://raw.githubusercontent.com/bedarkartejas-cyber/helix-images/main";
    ...
    const onlineMedia = [
        ...
        [
            "omen-17",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Omen%2017/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "omen-17",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Omen%2017/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "omen-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Omen%2016/img1.jpg?raw=true`,
            1,
            1,
        ],
        [
            "omen-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Omen%2016/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "omen-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Omen%2016/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "victus-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Victus%2016/img1.jpg?raw=true`,
            1,
            1,
        ],
        [
            "victus-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Victus%2016/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "victus-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Victus%2016/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "spectre-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Spectre%20x360%2016/img2.jpg?raw=true`,
            1,
            1,
        ],
        [
            "spectre-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Spectre%20x360%2016/img3.jpg?raw=true`,
            2,
            0,
        ],
        [
            "spectre-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Spectre%20x360%2016/img4.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "envy-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Envy%2016/img1.jpg?raw=true`,
            1,
            1,
        ],
        [
            "envy-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Envy%2016/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "envy-16",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Envy%2016/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "pavilion-plus-14-oled",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Pavillion%20Plus%2014%20OLED/img.jpg?raw=true`,
            1,
            1,
        ],
        [
            "pavilion-plus-14-oled",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Pavillion%20Plus%2014%20OLED/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "pavilion-plus-14-oled",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Pavillion%20Plus%2014%20OLED/img4.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "elitebook-840",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/EliteBook%20840%20g10/img1.jpg?raw=true`,
            1,
            1,
        ],
        [
            "elitebook-840",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/EliteBook%20840%20g10/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "elitebook-840",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/EliteBook%20840%20g10/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "probook-450",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/probook%20450%20G10/img1.jpg?raw=true`,
            1,
            1,
        ],
        [
            "probook-450",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/probook%20450%20G10/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "probook-450",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/probook%20450%20G10/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "elite-x360",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Elite%20x360%20830/img2.jpg?raw=true`,
            1,
            1,
        ],
        [
            "elite-x360",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Elite%20x360%20830/img1.jpg?raw=true`,
            2,
            0,
        ],
        [
            "elite-x360",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Elite%20x360%20830/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "pavilion-14-std",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/PavillionPlus14/img1.jpg?raw=true`,
            1,
            1,
        ],
        [
            "pavilion-14-std",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/PavillionPlus14/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "pavilion-14-std",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/PavillionPlus14/img3.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "pavilion-x360",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Pavillion%20x360%2014/img2.jpg?raw=true`,
            1,
            1,
        ],
        [
            "pavilion-x360",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Pavillion%20x360%2014/img3.jpg?raw=true`,
            2,
            0,
        ],
        [
            "pavilion-x360",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/Pavillion%20x360%2014/img4.jpg?raw=true`,
            3,
            0,
        ],
        ...
        [
            "hp-laptop-15",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/HP%20Laptop%2015/img1.jpg?raw=true`,
            1,
            1,
        ],
        [
            "hp-laptop-15",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/HP%20Laptop%2015/img2.jpg?raw=true`,
            2,
            0,
        ],
        [
            "hp-laptop-15",
            "image",
            `https://github.com/bedarkartejas-cyber/helix-images/blob/main/HP%20Laptop%2015/img3.jpg?raw=true`,
            3,
            0,
        ],
    ];
    ...
    const assets = [
        ...
        [
            ...
            "bento",
            "BEYOND FAST",
            "Lead your squad to victory with the latest GeForce RTX 40 Series Laptop GPUs - powered by AI.  Get the ultimate competitive advantage and stay connected with the newest and best tech GeForce has to offer.",
            JSON.stringify([
                "https://cdn.jsdelivr.net/gh/kartiknesari/helixApp@assets-only/.../imgi_15_3x-fps-2x.jpg",
                "https://cdn.jsdelivr.net/gh/kartiknesari/helixApp@assets-only/.../imgi_16_60-latency-2x.jpg",
            ]),
            JSON.stringify({
                align: "center",
                theme: "dark",
    ...
    */
    ...
    persistToDisk(db);
    console.log(
        "Database reset and seeded successfully with YOUR GITHUB images."
    );
}
